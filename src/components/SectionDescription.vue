...
<section id="section_description" :class="{isIntersecting: entry.isIntersecting}">
  <div class="container">
    ...
    <p>The most common usage of the Intersection Observer is detecting when a target enters the bounds of the root; mostly by scrolling. Therefore it is often thought of as a replacement for scroll event based position checking. Although in most cases the Intersection Observer provides a more performant solution than relying on scroll events, it is not necessarily a replacement.</p>
